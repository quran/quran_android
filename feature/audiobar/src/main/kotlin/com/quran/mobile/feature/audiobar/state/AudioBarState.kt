...
sealed class AudioBarUiEvent(val audioBarEvent: AudioBarEvent) : CircuitUiEvent {
  sealed class CommonPlaybackEvent(audioBarEvent: AudioBarEvent) : AudioBarUiEvent(audioBarEvent) {
  ...
  sealed class PlayingPlaybackEvent(audioBarEvent: AudioBarEvent) : AudioBarUiEvent(audioBarEvent) {
    data object Pause : PlayingPlaybackEvent(AudioBarEvent.Pause)
  }

  sealed class PausedPlaybackEvent(audioBarEvent: AudioBarEvent) : AudioBarUiEvent(audioBarEvent) {
  ...
  sealed class StoppedPlaybackEvent(audioBarEvent: AudioBarEvent) : AudioBarUiEvent(audioBarEvent) {
  ...
  sealed class CommonRecordingEvent(audioBarEvent: AudioBarEvent) : AudioBarUiEvent(audioBarEvent) {
