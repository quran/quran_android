...
import android.support.v7.appcompat.R;import android.support.v7.widget.ListPopupWindow;
...
public class SpinnerCompat extends AbsSpinnerCompat implements DialogInterface.OnClickListener {
     ...
     * @see #MODE_DROPDOWN
     */
    public SpinnerCompat(Context context, AttributeSet attrs, int defStyle, int mode) {
